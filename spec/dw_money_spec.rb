    ...
    context "when Money or Numeric objects" do
      ...
      context "when same currency" do
        it "subtracts new amount to current amount" do
          expect(DwMoney::Money.new(10.02, "USD") - DwMoney::Money.new(10.90, "USD")).to eq DwMoney::Money.new(-0.88, "USD")
        end
      end
      ...
      context "when different currencies" do
        ...
        context "with a conversion rate" do
          ...
          it "subtracts converted amount to current amount in current currency" do
            expect(DwMoney::Money.new(140.20, "USD") - DwMoney::Money.new(90, "EUR")).to eq DwMoney::Money.new(39.40, "USD")
          end
        end
    ...
    context "when Money or Numeric objects" do
      ...
      context "when same currency" do
        it "divides new amount to current amount" do
          expect(DwMoney::Money.new(10.02, "USD") / DwMoney::Money.new(-10.90, "USD")).to eq DwMoney::Money.new(-0.92, "USD")
        end
      end
      ...
      context "when different currencies" do
        ...
        context "with a conversion rate" do
          ...
          it "divides converted amount to current amount in current currency" do
            expect(DwMoney::Money.new(140.20, "USD") / DwMoney::Money.new(90, "EUR")).to eq DwMoney::Money.new(1.39, "USD")
          end
        end
    ...
    context "when Money or Numeric objects" do
      ...
      context "when same currency" do
        it "multiplies new amount to current amount" do
          expect(DwMoney::Money.new(10.02, "USD") * DwMoney::Money.new(-10.90, "USD")).to eq DwMoney::Money.new(-109.22, "USD")
        end
      end
      ...
      context "when different currencies" do
        ...
        context "with a conversion rate" do
          ...
          it "multiplies converted amount to current amount in current currency" do
            expect(DwMoney::Money.new(140.20, "USD") * DwMoney::Money.new(90, "EUR")).to eq DwMoney::Money.new(14132.16, "USD")
          end
        end
